...
import { QuestFinishedScreen } from '../QuestFinishedScreen';
...
describe('screens/QuestFinishedScreen', () => {
  ...
  beforeEach(() => {
    ...
    render(<QuestFinishedScreen {...mockedProps} />);
  });
  ...
  describe('닫기 버튼을 눌렀을 때', () => {
    it('navigation.goBack()이 호출되어야 한다', () => {
      ...
      render(withDripsy(<QuestFinishedScreen {...props} />));
